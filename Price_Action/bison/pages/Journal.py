...
#                 image_path = f"./Data/{stock_name}_{date}_{trade_type}_{image_uid}_image.jpg"
...
#                 # if 'Image' in df.columns and row['Image'] and os.path.exists(row['Image']):
#                 # if df.get('Image') is not None and row['Image'] and os.path.exists(row['Image']):
...
#                     if df.get('Image') is not None and row['Image']:
